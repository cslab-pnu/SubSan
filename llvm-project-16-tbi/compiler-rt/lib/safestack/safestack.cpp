...
extern "C" {
__attribute__((visibility("default"), tls_model("local-exec")))
...
__attribute__((tls_model("local-exec"))) __thread void *unsafe_stack_start = nullptr;
__attribute__((tls_model("local-exec"))) __thread size_t unsafe_stack_size = 0;
__attribute__((tls_model("local-exec"))) __thread size_t unsafe_stack_guard = 0;
